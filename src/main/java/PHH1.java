...
public class PHH1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("IO management");
        ...
        jButton6.setText("Process Communication");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PHH2 pWindows=new PHH2();
       pWindows.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Memoryyyy MWindow= new Memoryyyy();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
     MainSyncGui msgWindows=new MainSyncGui();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        SocketClient SCWindows=new SocketClient();
        SCWindows.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PHH1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
